...
// $("#menteeBtn").click(function () {
//     $("#left").html(
//         '<img src="img/mentee.svg" class="left_img">'
//     ).click(function () {
//         $(location).attr('href', 'splash');
//     });
//     $("#right").html(
...
//     "            <input id=\"first_name\" th:field=\"*{first_name}\" class=\"form-control\" type=\"text\">\n" +
//     "        </div>\n" +
//             "<div class=\"form-group\">\n" +
//     "            <label for=\"last_name\">Last Name:</label>\n" +
//     "            <input id=\"last_name\" th:field=\"*{last_name}\" class=\"form-control\" type=\"text\">\n" +
//     "        </div>\n" +
//         "        <div class=\"form-group\">\n" +
//         "            <label for=\"username\">Username:</label>\n" +
//         "            <input id=\"username\" th:field=\"*{username}\" class=\"form-control\" type=\"text\">\n" +
//         "        </div>\n" +
//         "        <div class=\"form-group\">\n" +
//         "            <label for=\"email\">Email:</label>\n" +
//         "            <input id=\"email\" th:field=\"*{email}\" class=\"form-control\" type=\"text\">\n" +
//         "        </div>\n" +
//         "        <div class=\"form-group\">\n" +
//         "            <label for=\"password\">Password:</label>\n" +
//         "            <input id=\"password\" th:field=\"*{password}\" class=\"form-control\" type=\"password\">\n" +
//         "        </div>\n" +
//         "        <input id='subButton' class='btn btn3'>\n" +
//         "</div>" +
//         "</div>"
//     );
...
//             "</div>" +
//             "<input type='submit' value='Next' id='next' class='btn btn3'>" +
//             "</form>" +
//             "</div>"
//         );
//         $("#upload").click(function () {
...
//                 "</div>" +
//                 "<button id='disagree' class='btn btn5'>Disagree</button>" +
//                 "<button id='agree' class='btn btn6'>Agree</button>" +
//                 "</div>"
//             );
...
// $("#mentorBtn").click(function () {
//     $("#left").html(
//         '<img src="img/mentorIcon.svg" class="left_img">'
//     ).click(function () {
//         $(location).attr('href', 'splash');
//     });
//     $("#right").html(
...
//         "        </div>\n" +
//         "        <input id='subButton' class='btn btn4'>\n" +
//         "</form>" +
//         "</div>" +
//         "</div>"
//     );
...
//             "<div></div>" +
//             "<input type='submit' value='Next' id='next' class='btn btn4'>" +
//             "</form>" +
//             "</div>"
//         );
//         $("#upload").click(function () {
